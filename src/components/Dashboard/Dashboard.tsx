        ...
        <div className={classes.root}>
            ...
            >
                ...
                <IconButton color='inherit' aria-label = 'open drawer' onClick = {handleDrawerOpen}
                    ...
                    <Button className = {classes.toolbar_button} onClick={handleDialogClickOpen} style={{ backgroundColor:'whitesmoke', marginLeft:'auto' }}> Create New Character </Button>

                    <Dialog open ={dialogOpen} onClose={handleDialongClickClose} aria-labelledby = 'form-dialog-title'>
                        ...
                        <DialogActions>
                            <Button onClick={handleDialongClickClose}>Cancel</Button>
                        </DialogActions>
                    </Dialog>
